...
import 'package:july_flutter_dart/SQFLite%20Files/LOGIN%20INTERFACE%202/home.dart';
...
class _Login_FormState extends State<Login_Form> {
  ...
  void logincheck12(String email, String password) async {
    if (email == 'admin@gmail.com' && password == '123456') {
      ...
      if (data.isNotEmpty) {
        Navigator.pushReplacement(context,
            MaterialPageRoute(builder: (context) =>Home55(data: data)));
        print('Login Success');
            ...
            Padding(
              ...
              child: MaterialButton(
                ...
                onPressed: () {
                  ...
                  if (valid) {
                    logincheck12(conemail.text, conpass.text);
                  } else {}
                },
