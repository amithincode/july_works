...
class SQLHelper {
  ...
  //1. create database
  static Future<sql.Database> myData() async { // creating path of the database
    return sql.openDatabase('myNotes.db', version: 1,
        onCreate: (sql.Database database, int version) async { // what happen to create database,oncreate
          await createTables(database);
        });
  }

  // add data's to  notes table inside myNotes.db
